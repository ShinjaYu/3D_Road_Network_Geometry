...
//为什么abstract? Video 1:47:50
abstract class InfrastructureBehavior : MonoBehaviour // now this is a base class
{
    ...
    //protected: being able to be accessed from this and other classes 
    protected Vector3 GetCentre(OsmWay way) // find centers of buildings
    {
    ...
    protected void CreateObject(OsmWay way, Material mat, string objectName)
    {
        ...
        objectName = string.IsNullOrEmpty(objectName) ? "OsmWay" + " " + way.ID.ToString() : objectName + " "+ way.ID.ToString();
    ...
    protected abstract void OnObjectCreated(OsmWay way, Vector3 origin, List<Vector3> vectors, 
